...
qk_tap_dance_action_t tap_dance_actions[] = {
    [TD_GRV_REG] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_GRV, _SA),
    [TD_GRV_LCA] = ACTION_TAP_DANCE_LAYER_TOGGLE(LCA(KC_GRV), _SA),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_NP] = LAYOUT(
        _______, _______, _______, _______, _______, KC_PAST, KC_PSLS, KC_PMNS, KC_PPLS, _______, _______, _______, _______,          _______, KC_LNUM, _______,
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_P1, 	KC_P2,	 KC_P3,   _______, _______, KC_PENT,
        _______, _______, KC_PAST, _______, _______, _______, _______, KC_P0, 	KC_PCMM, KC_PDOT, KC_PSLS, _______,                            _______,
        _______, TG(_ML), _______,                   _______,                            _______, TG(_NP), _______, _______,          _______, _______, _______
    ),    
	[_ML] = LAYOUT(
	...
	[_SA] = LAYOUT(
        ...
        TD(TD_GRV_LCA), LCA(KC_1), LCA(KC_2), LCA(KC_3), LCA(KC_4), LCA(KC_5), LCA(KC_6), LCA(KC_7), LCA(KC_8), LCA(KC_9),   LCA(KC_0),    LCA(KC_MINS), LCA(KC_EQL),  LCA(KC_BSPC),  _______,     _______, LCA(KC_PGUP),
        _______,  	    LCA(KC_Q), LCA(KC_W), LCA(KC_E), LCA(KC_R), LCA(KC_T), LCA(KC_Y), LCA(KC_U), LCA(KC_I), LCA(KC_O),   LCA(KC_P),    _______,      LCA(KC_RBRC), LCA(KC_BSLS),  LCTL(KC_DEL), _______, LCA(KC_PGDN),
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [_FL] = {
        _______, _______, _______, _______, _______, _______, _______, _______, _______, CORAL,   CORAL,   RED,      RED,               _______, _______, TEAL,
        _______, _______, PINK,    PINK,    PINK,    _______, _______, _______, _______, GREEN,   GREEN,   SPRING,   SPRING,   _______, TEAL,    TEAL,    TEAL,
        ...
        _______, ORANGE,  _______, CORAL,   _______, AZURE,   AZURE,   _______, _______, _______, _______, _______,                              SPRING,
        _______, _______, _______,                   _______,                            _______, PINK,    _______, _______,            _______, SPRING, _______
    },
    [_NP] = {
        _______, _______, _______, _______, _______, CORAL,   ORANGE,  GREEN,   SPRING,  _______, _______, _______, _______,          _______, GOLD, _______,
        _______, _______, _______, _______, _______, _______, _______, TEAL, 	TEAL,	 TEAL,	  _______, GREEN,   SPRING,  _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, TEAL, 	TEAL, 	 TEAL,    _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, TEAL, 	TEAL,	 TEAL,    _______, _______, TEAL,
        _______, _______, CORAL,   _______, _______, _______, _______, TEAL, 	AZURE,   AZURE,   ORANGE,  _______,                            _______,
	...
	[_SA] = {
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,         _______, _______, _______,
        CHART,   GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   CHART,   CHART,  GREEN,   _______, _______, AZURE,
        _______, GREEN,   SPRING,  SPRING,  GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   _______, CHART,  CHART,   GREEN,   _______, AZURE,
        _______, GREEN,   SPRING,  GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   _______, _______, GREEN,
        GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   GREEN,   SPRING,  GREEN,   _______, CHART,   GREEN,   _______,                         _______,
        SPRING,    _______, _______,                   GREEN,                            _______, PINK,    _______, GREEN,          SPRING, _______, GREEN
    },
};
