...
#define RGB_MATRIX_STARTUP_SPD 70
...
// #define RGBLIGHT_EFFECT_STATIC_GRADIENT // Enable static gradient mode.
 ...
 #define RGBLIGHT_EFFECT_BREATHE_CENTER 2.7            // If defined, used to calculate the curve for the breathing animation. Valid values are 1.0 to 2.7
