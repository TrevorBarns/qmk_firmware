...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_APP_NP] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_APP, _NP),
    [TD_WAKE] = ACTION_TAP_DANCE_DOUBLE(KC_TRNS, KC_W),
    [TD_SLEEP] = ACTION_TAP_DANCE_DOUBLE(KC_TRNS, KC_S),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_KL] = LAYOUT(
        ...
        KC_LCTRL,  TD(TD_LGUI_ML), KC_LALT,                   KC_SPC,                             KC_RALT, TT(_FL), TD(TD_APP_NP),     KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FL] = LAYOUT(
        ...
        _______, _______, TG(_ML), TG(_GL),  TG(_NP), _______, _______, _______,  _______,  ROUT_FM, ROUT_TG, ROUT_VD, ROUT_VI, _______, KC_MSTP, KC_MPLY, KC_VOLU,
	...
	[_NP] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, KC_PAST, _______, _______, KC_PMNS, KC_PPLS, _______, _______, _______, _______,
        _______, KC_P7,   KC_P8,   KC_P9, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, KC_P4,   KC_P5,   KC_P6, _______, _______, _______, _______, _______, _______, _______, _______, KC_PENT,
        _______, KC_P1,   KC_P2,   KC_P3, KC_PENT, _______, _______, _______, _______, KC_PDOT, KC_PSLS, _______,                                      _______,
        _______, TG(_NP), KC_P0,                       _______,                  _______, TG(_NP), _______, _______,          _______, _______, _______
	),
    /*
    [X] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [_FL] = {
        MAGENT, CORAL,   CORAL,   _______, _______, CORAL,   CORAL,   _______, _______, CORAL,   _______, YELLOW,  YELLOW,           TEAL,    GOLD,   GOLD,
	...
	[_NP] = {
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, ORANGE,  _______,
        _______, _______, _______, _______, _______, _______, _______, _______, ORANGE,  _______, _______, ORANGE,  ORANGE,  _______, _______, _______, _______,
        _______, GOLD,    GOLD,    GOLD,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, GOLD,    ORANGE,  GOLD,    _______, _______, _______, _______, _______, _______, _______, _______,  ORANGE,
        _______, GOLD,    GOLD,    GOLD,    ORANGE,  _______, _______, _______, _______, ORANGE, ORANGE,   _______,                            _______,
        _______, PINK,    GOLD,                       _______,                           _______, PINK, _______, _______,         	  _______, _______, _______
	},
};
/*
#define RED {HSV_RED}
